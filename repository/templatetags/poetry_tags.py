...
class RecentPoetryNode(Node):
    ...
    def __init__(self, count=5, varname=None, creator=None, language=None, tag=None, published=False):
        self.count = count
        self.varname = varname
        self.creator = template.Variable(creator)
...
class SimilarPoetryNode(Node):
    ...
    def __init__(self, count=5, varname=None, poetry=None):
        self.count = count
        self.varname = varname
        self.poetry = template.Variable(poetry)
...
def get_recent_poetries(parser, token):
    ...
    Syntax::
        ...
        case 5: {% get_recent_poetries [count] published as [varname] %}
    ...
    Example usage::
        ...
        {% get_recent_poetries 5 published as poetry_list %}
    """     
